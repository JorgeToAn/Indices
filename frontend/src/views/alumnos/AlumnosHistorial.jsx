            ...
            <Group align="flex-start" spacing="3vw">
                <Flex direction="column">
                    <form>
                        ...
                        <TextInput label="No. de control" withAsterisk/>
                        <Group className="input-group">
                            <TextInput label="Sexo" withAsterisk width="45%"/>
                            <TextInput label="Edad" withAsterisk width="45%"/>
                        </Group>
                        <Group className="input-group">
                            <Select
                                width="45%"
                        ...
                        <Checkbox labelPosition='left' color='toronja' mt={15} label='Liberacion de inglés (2018-1)' radius='sm' />
                        { editar ?
                            <Group className="input-group">
